...
class Home extends BaseController
{
     ...
     *
     * @param CcrudTestModel $model
     *            Instância do model de testes.
     *            
     * @return bool
     */
    ...
    private function createAndSeedTable(): void
    {
        ...
        for ($i = $current; $i < 150; $i ++) {
            $builder->insert([
                ...
                'enum_col' => $faker->randomElement([
                    'A',
                    'B',
                    'C'
                ]),
                'set_col' => implode(',', $faker->randomElements([
                    'X',
                    'Y',
                    'Z'
                ], $faker->numberBetween(1, 3))),
                'json_col' => json_encode([
                    'value' => $faker->word
                ]),
